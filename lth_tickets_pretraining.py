...
def parser():
    ...
    parser.add_argument("--num-iteration", type=int, default=500)
...
def main():
    ...
    for seed in range(args.iters):
        ...
        savepath = osp.join(args.savedir, f"seed_{seed}_iter_{args.num_iteration}.pth")
        ...
        for epoch in range(1, args.epochs * args.multiplier + 1):
            ...
            torch.save(
                {
                    "state_dict": model.state_dict(),  # get_sparse_state_dict(model),
