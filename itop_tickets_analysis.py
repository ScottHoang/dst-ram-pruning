...
if __name__ == "__main__":
    ...
    savedirs = [
        ...
        # "results_v2/random+magnitude+vanilla/ERK/ResNet18/0.01/",
    ...
    for savedir in tqdm.tqdm(savedirs, total=len(savedirs)):
        ...
        for seed in seeds:
            ...
            generate_scatter_point_series(data, "epochs", ["iou_heatmap"], outputdir)
            ## acc series
            print("generating acc series")
            generate_scatter_point_series(
                data, "test_acc", ["iou_heatmap", "epochs"], outputdir, swapaxis=True
            )
            ## imdb vs acc vs ....
